...
class Dirscan(object):
    ...
    def _analysis404(self):
        notFoundPage = requests.get(self.scanSite + '/111111111111111111/111111.html', allow_redirects=False, verify=False)
        self.notFoundPageText = notFoundPage.text.replace('/111111111111111111/111111.html', '')
    ...
    def _scan(self, url):
        html_result = 0
        try:
            html_result = requests.get(url, headers=self.headers, allow_redirects=False, verify=False, timeout=500)
